...
public class FileFaceDetectionAsyncTask extends AsyncTask<Void, Void, List<RNFaceDetector.Face>> {
  ...
  @Override
  protected List<RNFaceDetector.Face> doInBackground(Void... voids) {
    if (isCancelled()) {
      return null;
    }
    ...
    byte[] imageData = ImageUtils.bitmapToBgr24(bitmap);
    return mRNFaceDetector.detect(imageData, mWidth, mHeight, FaceEngine.CP_PAF_BGR24);
  }
